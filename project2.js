...
setLocalData() {
   ...
   upadateWalletBalance(balance){
    App.elements.header.container.menuLeft2.wallet.innerHTML =  `Saldo:    ${new Intl.NumberFormat("pt-BR", { style: "currency", currency: "BRL",}).format(balance)}`
   },

showPopup(){
    //POPUP DESCRIÇÃO DAS SKILLS
    App.elements.popupEspada.backdrop.style.display ="flex"
    App.elements.popupEspada.container.description.innerHTML= "Seus golpes causam dano de fogo em area, aplicando queimadura nos inimigos ao seu redor. Queimadura causa 5% de dano baseado na vida máxima dos alvos ao longo de 5seg. Queimadura aculma até 3 vezes. Se espírito do imperador estiver ativo, queimaduras acumulam-se até 6 vezes."
...
App.helpers.style(els.container.el,{
       ...
       textAlign: "center",
       marginBottom: "250px",
       backgroundImage: "radial-gradient(circle at 77.39% 34.18%, #ffffff 0, #f7ffff 16.67%, #edffff 33.33%, #e2eeee 50%, #d7d3d3 66.67%, #ccbcba 83.33%, #c2a8a2 100%)"
    })
...
App.helpers.style(els.container.compra.confirmButtons.el, {
  ...
  App.helpers.style(els.container.compra.text,{
      ...
      els.container.compra.text.innerHTML = " <br><br> ATENÇÃO!!<br><br> Certifique-se de estar cadastrado e logado com o mesmo ID da conta para qual deseja enviar o item. <br><br> "
    ...
    els.container.compra.confirmButtons.el.appendChild(els.container.compra.confirmButtons.confirm)
    els.container.compra.confirmButtons.el.appendChild(els.container.compra.confirmButtons.cancel)
...
App.helpers.style(els.container.close.divButtons.cadastro,{
  ...
  App.helpers.style(els.container.close.text,{
      ...
      els.container.close.text.innerHTML = "<br><br> Você precisa estar logado para poder comprar.<br><br> Certifique-se de estar logado com o mesmo ID da conta para qual você deseja enviar o item comprado. "
...
els.container.close.divButtons.el.appendChild(els.container.close.divButtons.log)
els.container.close.divButtons.el.appendChild(els.container.close.divButtons.cadastro)
...
App.elements.app.appendChild(els.backdropTela)
   ...
   createCard(weapons, isBuy) {
            ...
            l4.innerHTML = "Preço:"
            v4.innerHTML =  new Intl.NumberFormat("pt-BR", { style: "currency", currency: "BRL",}).format(weapons.price)
          ...
          if(App.state.wallet.balance >= weapons.price) { 
            ...
            msgSuccess.setAttribute('style', 'color: green')
                    ...
                    setTimeout(()=>{
                       ...
                       msgSuccess.textContent = "Compra realizada com sucesso!! Uma cópia do item foi enviado para seu depósito.  Caso esteja logado com sua conta no jogo, saia e entre novamente."  
     ...
     createMiticCard(mitic, isBuy) {
        ...
        l4.innerHTML = "Preço:"
        v4.innerHTML = new Intl.NumberFormat("pt-BR", { style: "currency", currency: "BRL",}).format(mitic.price)
  ...
  els.appendChild(header)
      ...
      editMitic2(mitico, isBuy) {
        ...
        l4.innerHTML = "Preço:"
        v4.innerHTML = new Intl.NumberFormat("pt-BR", { style: "currency", currency: "BRL",}).format(mitico.price)
        l4.classList.add("mitic-card-l4")
        v4.classList.add("mitic-card-v4")
     ...
     renderEpic (){
       ...
       showEpic.addEventListener('click', function() {
        ...
        for (let i = 0; i < App.state.weapons.length; i ++){
            ...
            App.elements.body.container.el.appendChild(App.elements.body.container.all)
...
//BOTÃO QUE MOSTRA SOMENTE O PRIMEIRO ITEN MITICO E ESCONDE O RESTANTE, FUNCIONA COMO UM TIPO DE FILTRO.
    ...
    console.log(App.state.lengendary)
     ...
     showLegend.addEventListener('click', function() {
       ...
       const commum = document.getElementById('commumContainer')
        ...
        const legend = document.getElementById('LegendContainer')
        if(legend.style.display !== "none" ||legend.style.display !== "flex"){
 ...
 renderCommum(){
    ...
    console.log(App.state.commum)
     ...
     const commum = document.getElementById('commumContainer')
      ...
      showCommum.addEventListener('click', function() {
        if(commum.style.display !== "none" ||commum.style.display !== "flex"){
    ...
    for (let o = 0; o < App.state.commum.length; o ++){
     ...
     App.helpers.style(header.container.el,{  display: 'flex', justifyContent: 'space-around', alignItems: 'center'})
       ...
       App.helpers.style(header.container.menuLeft2.el, {
            ...
            header.container.menuLeft2.el.appendChild(header.container.menuLeft2.textSaldo)
          
           
            header.container.menuLeft2.el.appendChild(header.container.menuLeft2.wallet)
            header.container.menuLeft2.el.appendChild(header.container.menuLeft2.sair)
